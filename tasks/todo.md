...
Status: 0.1.0 published; user pushes + trust setup (task 6); Phase 5 review next. Spec: SPEC-npm-publish.md
...
- [x] 5. ⚠ First publish 0.1.0 (gate before `npm publish`) - Docs: README badges/install, CHANGELOG, HOW-IT-WORKS uninstall
